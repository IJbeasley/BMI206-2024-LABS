...
```{r q4_7, eval = FALSE}
# Change with the number of resamples: 
...
# mcols(reg_active) = mcols(reg_active) |> 
#                     as.data.frame() |> 
#                     dplyr::select("signalValue")

right_vent = c("vent_epi" = "AH29557")

# annotations = build_ah_annots(genome, 
#                               right_vent, 
#                               annotation_class = "H3k27ac")

# annotations = build_annotations(genome = 'hg19', annotations = reg_active)
# 
